...
const Concept = () => {
  return (
    <>
      <div className="bg-[#EFEBD9] py-[60px] text-[#1e2127] custom-padding-lr px-[90px] gap-[60px] items-center">
        <h2
          id="concept"
          className="font-[AmaticBold] text-[5rem] text-center z-10 m-0 p-0"
        >
          Le concept
        </h2>
        <section id="concept" aria-labelledby="concept">
          <div className=" w-[100%] flex flex-col justify-start relative gap-[20px] custom-padding-lr2">
            <p className="z-10">
              ...
              parcourir les œuvres : – un parcours interactif et ludique, guidé
              et dynamique, – un parcours libre pour explorer à votre rythme. Le
              ...
              invite à une découverte différente, entre surprise, contemplation
              et imagination.
            </p>
          </div>
          <div className=" w-full flex justify-center pt-[40px] gap-[90px] ">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-[1rem] mt-2 uppercase">6 salles</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-[1rem] mt-2 uppercase">16 artistes</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-[1rem] mt-2 uppercase">6 mini-jeux</p>
            </div>
          </div>
          <Slider />
        </section>
