    ...
    >
      ...
      <div className=" w-[100%] flex flex-col justify-start relative gap-[20px] custom-padding-lr2">
        <p className="z-10">
          ...
          dynamique, – un parcours libre pour explorer à votre rythme. Le musée
          se compose de six salles, chacune avec son atmosphère unique : jaune,
          verte, bleue, rose, noire et blanche. Chaque espace vous invite à une
          découverte différente, entre surprise, contemplation et imagination.
        </p>
      </div>
